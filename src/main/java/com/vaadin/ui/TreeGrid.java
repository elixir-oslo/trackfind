...
public class TreeGrid<T> extends Grid<T>
     ...
     *
     * @param propertySet      the property set implementation to use, not {@code null}
     * @param dataCommunicator the data communicator to use, not {@code null}
     */
     ...
     *
     * @param dataCommunicator the custom data communicator to set
     */
     ...
     * not supported.
     *
     * @param id id of the column to use for displaying hierarchy
     ...
     * @param userOriginated whether the expand was triggered by a user interaction or the
     *                       server
     */
     ...
     * @param userOriginated whether the collapse was triggered by a user interaction or
     *                       the server
     */
