...
public class HierarchicalDataCommunicator<T> extends DataCommunicator<T> {
     ...
     * Set the current hierarchical data provider for this communicator.
     *
     * @param dataProvider  the data provider to set, must extend
     ...
     *
     * @param item           the item to collapse
     * @param syncAndRefresh {@code true} if the changes should be synchronised to the
