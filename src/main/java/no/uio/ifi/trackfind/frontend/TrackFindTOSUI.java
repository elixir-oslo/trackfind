...
/**
 * Terms of Service Vaadin UI of the application.
...
@Theme("trackfind")
@Slf4j
public class TrackFindTOSUI extends AbstractUI {
    ...
    private HorizontalLayout buildMainLayout() {
        ...
        content.setSizeFull();
        try {
            String html = IOUtils.resourceToString("/tos.html", Charset.defaultCharset());
            content.setValue(html);
            content.setContentMode(ContentMode.HTML);
        } catch (IOException e) {
            log.error(e.getMessage(), e);
        }
        Panel panel = new Panel("Terms of Service", new VerticalLayout(content));
        panel.setSizeFull();
