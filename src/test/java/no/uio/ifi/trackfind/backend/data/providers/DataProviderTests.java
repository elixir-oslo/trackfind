...
public class DataProviderTests {
    ...
    public void searchNoneTest() {
        Collection<Map> search = dataProvider.search("key1: value3");
    ...
    public void searchOneTest() {
        Collection<Map> search = dataProvider.search("key1: value1");
    ...
    public void searchTwoTest() {
        Collection<Map> search = dataProvider.search("key1: value1 OR key2: value3");
